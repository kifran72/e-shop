<template>
  ...
  <SfBottomNavigation class="navigation-bottom smartphone-only">
    <SfBottomNavigationItem
      ...
      icon="home" size="20px" label="Accueil"
      @click="handleHomeClick"
    />
    <SfBottomNavigationItem icon="menu" size="20px" label="Menu" @click="toggleMobileMenu"/>
    <SfBottomNavigationItem icon="heart" size="20px" label="Favoris" @click="toggleWishlistSidebar"/>
    <SfBottomNavigationItem icon="profile" size="20px" label="Compte" @click="handleAccountClick"/>
